...
class SendProductDetailUpdatedNotification
{
    public function handle(ProductDetailUpdated $productDetailUpdated)
    {
        $product = $productDetailUpdated->getProduct()->fresh([
            'branches',
        ...
        $event = new Event([
            'id' => Str::orderedUuid(),
            'event_name' => WebHookEvent::PARTNER_PRODUCT_UPDATED,
            'payload' => $product,
