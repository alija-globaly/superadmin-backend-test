...
class SendProductFeeUpdatedNotification
{
    public function handle(ProductFeeUpdated $productFeeUpdated)
    {
        $product = $productFeeUpdated->getProduct()->fresh([
        ...
        $event = new Event([
            'id' => Str::orderedUuid(),
            'event_name' => WebHookEvent::PARTNER_PRODUCT_FEE_UPDATED,
            'payload' => $product,
